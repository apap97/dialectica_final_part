...
describe('Pull Requests list being filtered by state filter "Merged" and has column "Comments" sorted in descending order ', () => {
  it('Tests if column "Comments" is sorted in descending order while state filter value equals "Merged"', () => {
