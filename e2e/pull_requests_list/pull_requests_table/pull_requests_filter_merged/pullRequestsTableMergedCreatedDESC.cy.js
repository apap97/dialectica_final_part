...
describe('Pull Requests list being filtered by state filter "Merged" and has column "Created" sorted in descending order ', () => {
  it('Tests if column "Created" is sorted in descending order while state filter value equals "Merged"', () => {
