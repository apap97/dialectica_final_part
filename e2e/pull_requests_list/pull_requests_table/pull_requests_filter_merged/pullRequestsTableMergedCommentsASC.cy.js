import { parse, setMonth } from "date-fns"
import { recurse } from 'cypress-recurse'

describe('Pull Requests list being filtered by state filter "Merged" and has column "Comments" sorted in ascending order ', () => {
  it('Tests if column "Comments" is sorted in ascending order while state filter value equals "Merged"', () => {
