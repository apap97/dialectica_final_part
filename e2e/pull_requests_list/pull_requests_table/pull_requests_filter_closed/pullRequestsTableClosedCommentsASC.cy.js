...
describe('Pull Requests list being filtered by state filter "Closed" and has column "Comments" sorted in ascending order ', () => {
  it('Tests if column "Comments" is sorted in ascending order while state filter value equals "Closed"', () => {
