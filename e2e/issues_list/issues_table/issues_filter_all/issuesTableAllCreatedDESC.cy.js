...
describe('Issues list being filtered by state filter "All" and has column "Created" sorted in descending order ', () => {
  it('Tests if column "Created" is sorted in descending order while state filter value equals "All"', () => {
