...
describe('Issues list being filtered by state filter "All" and has column "Created" sorted in ascending order ', () => {
  it('Tests if column "Created" is sorted in ascending order while state filter value equals "All"', () => {
