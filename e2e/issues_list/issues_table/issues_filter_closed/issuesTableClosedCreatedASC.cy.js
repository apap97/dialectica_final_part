...
describe('Issues list being filtered by state filter "Closed" and has column "Created" sorted in ascending order ', () => {
  it('Tests if column "Created" is sorted in ascending order while state filter value equals "Closed"', () => {
...
recurse(
  ...
  },
  {
    ...
    //Test case 9
    //Sigle click on header "Created" in order to have elements represended in ascending way
